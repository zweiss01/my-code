 ...
 * 			ascending name using a linked list. 
 * 			The user can then add and delete from the
...
public class ShoppingDemoWeiss 
{
	...
	{
		KeyedListWeiss linkedShoppingList = new KeyedListWeiss();
		char action;
		String itemKeyName;
		boolean itemChanged = false;
		linkedShoppingList = readFile();
		...
		do
		{
			...
			case '1': ItemWeiss newItem = new ItemWeiss();
					  ...
					  itemChanged = linkedShoppingList.add(newItem);
			...
			case '2': System.out.print("Enter the name of the item you want to delete: ");
					  ...
					  itemChanged = linkedShoppingList.remove(itemKeyName);
					  if(itemChanged == false)
